...
if __name__ == '__main__':
    ...
    parser.add_argument('--no_zero_norm', action='store_true', default=False, help='whether to use zero normalization')
    ...
    with open('/kaggle/working/Implement-Paper/eval_results/mi_results.txt','a') as f:
        f.write(setting + "  \n")
